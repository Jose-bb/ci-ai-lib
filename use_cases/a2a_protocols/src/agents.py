...
software_agent = autogen.AssistantAgent(
    ...
    system_message=(
        ...
        "TOOL DELEGATION: DO NOT ask the 'User_Proxy' to run manual system commands (e.g., in their terminal) "
        "unless absolutely necessary. First, actively ask your team members (like the 'Hardware_Specialist') "
        "if they have automated tools to fetch the required system metrics or logs. "
